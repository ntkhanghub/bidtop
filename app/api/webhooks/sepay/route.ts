...
// The only place allowed to call confirm_bid_and_increment(), per CLAUDE.md's
// rank-integrity rule. Verifies the X-Secret-Key header before any DB call.
// Uses real HTTP status codes (401/400/500), matching SePay's documented
// "must return HTTP 200" ack contract literally.
//
